...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?= get_template_directory_uri();?>/img/core-img/favicon.ico">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 d-flex justify-content-between">
                        <!-- Logo Area -->
                        <div class="logo">
                            <a href="index.html"><img src="<?= get_template_directory_uri();?>/img/core-img/logo.png" alt=""></a>
                        </div>

                        <!-- Top Contact Info -->
                        <div class="top-contact-info d-flex align-items-center">
                            <a href="#" data-toggle="tooltip" data-placement="bottom" title="25 th Street Avenue, Los Angeles, CA"><img src="<?= get_template_directory_uri();?>/img/core-img/placeholder.png" alt=""> <span>25 th Street Avenue, Los Angeles, CA</span></a>
                            <a href="#" data-toggle="tooltip" data-placement="bottom" title="office@yourfirm.com"><img src="<?= get_template_directory_uri();?>/img/core-img/message.png" alt=""> <span>office@yourfirm.com</span></a>
                        </div>
                    </div>
                </div>
            </div>
...
<!--                                 <ul>
                        ...
                        <!-- Contact -->
                        <div class="contact">
                            <a href="#"><img src="<?= get_template_directory_uri();?>/img/core-img/call2.png" alt=""> +800 49 900 900</a>
                        </div>
                    </nav>
                </div>
            </div>
